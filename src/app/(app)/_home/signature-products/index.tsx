...
const signaturesMapper = (
  product: (typeof featuredSignatures)[number],
  index: number,
) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className="m-0 font-display text-headline/normal font-semibold tracking-normal text-neutral-950">
          {product.name}
        </h3>
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-16 lg:gap-24">
        {featuredSignatures.map(signaturesMapper)}
      </div>
